...
const ItemCount = ({ stock, initial, onAdd}) => {
    ...
    return (
        <>
            <div className='bg-neutral-300 w-3/4 pb-3 sm:self-center'>
                <div className='flex justify-center items-center pt-1.5 md:border-y'>
                    <button onClick={restarCantidad}> <RemoveIcon fontSize='small' className="text-gray-900 h-5 w-5 flex-shrink-0" ></RemoveIcon> </button>
                    <p className='font-bold mx-2 text-center'>{contador}</p>
