...
import image from "../../assets/vapeimg.svg"
		...
		<>
			{carrito.length > 0 ? (
				<div className="w-full absolute z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="checkout">
					<div className="flex md:flex-row flex-col justify-end bg-gray-100" id="cart">
										...
										<div className="md:pl-3 md:w-3/4 w-full">
											...
											<div className="flex items-center justify-between pt-5 pr-6">
												<div className="flex itemms-center">
													<button onClick={() => delProduct(element.id)} className="text-xs leading-3 underline text-red-500 pl-5 cursor-pointer">Eliminar producto</button>
												</div>
				...
				<div className="flex flex-col items-center pb-[179px]">
					<h1 className="md:text-7xl text-4xl font-black leading-10 text-gray-800 sm:text-center"> Su carrito esta vacio</h1>
					<Link to="/"><img className="w-48" src={image} alt="" /></Link>
					<Link className="font-black leading-10 text-gray-800" to="/">Volver a la pagina principal</Link>
				</div>
			)
			}
		</>
