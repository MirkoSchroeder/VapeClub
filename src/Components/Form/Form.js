...
import imgVapecart from "../../assets/vapeCart.svg"
    ...
    return (
        <>
            {finish === false ? (
                ...
                (
                    <div className="pt-8 pb-[53px] flex flex-col justify-center items-center">
                        <h3 className="sm:text-2xl font-medium text-red-500">Gracias por su compra!</h3>
                        <div className="flex flex-col items-center">
                            <p className="text-sm font-semibold text-center">Este es su ticket de compra. Guardelo para cualquier reclamo</p>
                            <p className="text-lg font-black border-2 border-red-500 p-3.5">{ticket}</p>
                            <p className="text-sm font-bold text-center">Pronto nos estaremos comunicando con usted por Whatsapp o eMail.</p>
                            <Link to="/"><img className="w-48" src={imgVapecart} alt="" /></Link>
                            <Link className="italic font-medium" to="/">Volver al inicio</Link>
                        </div>
                    </div>
                )
            }
